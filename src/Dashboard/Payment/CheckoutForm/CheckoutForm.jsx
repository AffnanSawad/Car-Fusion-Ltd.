        ...
        if (confirmError) {
            ...
            if (paymentIntent.status === 'succeeded') {
                ...
                const payment = {
                    ...
                    menuItemIds: cart.map(item => item.
                        carId
                        ),
                    status: 'pending'
                }
...
<form onSubmit={handleSubmit} className="max-w-sm mx-auto p-8 bg-gray-100 rounded-lg shadow-xl mt-20">
        <h2 className="text-2xl font-bold text-center mb-6">💳 Complete Your Payment</h2>
      
        <div className="mt-12 mb-4">
          <label htmlFor="card-details" className="block text-sm font-semibold text-gray-700 mb-4 ">
