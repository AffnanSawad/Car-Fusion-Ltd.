...
const Dashboard = () => {
    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          {/* Sidebar */}
          <div className="lg:w-64 w-full min-h-screen bg-gradient-to-b from-orange-400 to-orange-300 text-black font-semibold p-6 shadow-lg">
            {/* Logo or Title */}
            <h2 className="text-2xl font-extrabold tracking-wide text-center mb-8">Car Fusion</h2>
  ...
  >
    💳 Payment
            ...
            {/* Divider */}
            <div className="mt-10 border-t border-white/20 pt-4 text-center text-sm text-black/70">
              © 2025 Car Fusion
            </div>
          </div>
